...
const Sidebar = () => {
  ...
  return (
    <div className="w-1/3 border-r-2 border-primary-border p-4 rounded-lg shadow-md">
      <div>
        <textarea
        ...
        <div className="flex gap-5 justify-between">
          ...
          <button
            className="block w-1/2 px-4 py-2 mb-4 bg-primary-0 text-primary-text rounded-md hover:bg-primary-2 border-primary-border"
